...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::GetFriendsListRequest)},
  { 7, -1, -1, sizeof(::fixbug::GetFriendsListResponse)},
};
...
const ::_pbi::DescriptorTable descriptor_table_friend_2eproto = {
    false, false, 269, descriptor_table_protodef_friend_2eproto,
    "friend.proto",
